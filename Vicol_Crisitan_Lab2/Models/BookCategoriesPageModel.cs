...

{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Vicol_Crisitan_Lab2Context context,
        Book book)
        {
            var allCategories = context.BookCategory;
        ...
        public void UpdateBookCategories(Vicol_Crisitan_Lab2Context context,
        string[] selectedCategories, Book bookToUpdate)
        {
            ...
            foreach (var cat in context.BookCategory)
            {
